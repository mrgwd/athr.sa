...
import { ShoppingCart, GlobalEdit } from "iconsax-react";
function ServicesSection() {
  ...
  return (
    <div
      ref={sSection}
      className="container mx-auto my-24 translate-y-20 px-4 opacity-0 transition duration-500 md:mt-36"
    >
      <h2 className="mb-12 text-center text-main-color sm:text-xl md:mb-20 lg:text-2xl">
        {t("services.heading")}
      </h2>
      <div className="grid grid-cols-1 justify-center gap-5 child:flex child:items-start child:gap-2 child:rounded-3xl child:bg-gradient-to-b child:px-6 child:py-8 child:transition-all child-hover:scale-105 sm:grid-cols-2 sm:gap-8 child:sm:block child:sm:rounded-[3rem] child:sm:px-12 child:sm:py-16 md:gap-12 xl:grid-cols-3 2xl:gap-20">
        <Link
          to="/OSservices"
        ...
        >
          <ShoppingCart
            variant="Bulk"
            className="mx-auto h-20 w-44 sm:h-32 sm:w-32"
          />
          <div>
            <h3 className="text-md mt-2 font-bold sm:text-2xl">
              {t("services.onlineStores.subHeading")}
            </h3>
            <p className="text-sm font-normal sm:mt-8 sm:text-base">
              {t("services.onlineStores.caption")}
            </p>
          </div>
          <span className="mt-8 hidden sm:block">
            {t("services.onlineStores.readMore")}
        ...
        >
          ...
          <div>
            <h3 className="text-md mt-2 font-bold sm:text-2xl">
              {t("services.webDev.subHeading")}
            </h3>
            <p className="text-sm font-normal sm:mt-8 sm:text-base">
              {t("services.webDev.caption")}
            </p>
          </div>
          <span className="mt-8 hidden sm:block">
            {t("services.webDev.readMore")}
        ...
        >
          ...
          <div>
            ...
            <h3 className="text-md mt-2 font-bold sm:text-2xl">
              {t("services.socialMediaDesigns.subHeading")}
            </h3>
            <p className="text-sm font-normal sm:mt-8 sm:text-base">
              {t("services.socialMediaDesigns.caption")}
            </p>
          </div>
          <span className="mt-8 hidden sm:block">
            {t("services.socialMediaDesigns.readMore")}

  ...
  return (
    ...
    >
      <div className="relative">
        <div
          data-slider
          className="relative mx-auto grid w-full scale-90 grid-cols-3 items-center justify-items-center gap-6 child:max-h-20 child:cursor-pointer child:object-cover child:opacity-60 child:grayscale child:transition-all child-hover:opacity-100 child-hover:grayscale-0 sm:scale-100 sm:gap-6 md:w-3/4 md:grid-cols-4 md:gap-9 lg:grid-cols-7 lg:gap-12"
        >

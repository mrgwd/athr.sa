  ...
  return (
    <main className="container mx-auto items-center justify-between px-4 md:max-lg:flex">
      ...
      <div className="mt-16 child:max-md:text-center sm:mt-36 md:max-lg:inline-block lg:max-xl:mt-20">
        ...
        <button className="text-md mt-10 block rounded-full bg-gradient-to-r from-main-color to-main-blue-gradient px-6 py-2 text-white max-md:mx-auto sm:px-10 sm:py-3 sm:text-lg">
          تواصل معنا
        </button>
      </div>
